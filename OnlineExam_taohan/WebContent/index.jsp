...
<link href='${path }/images/reception/logo_index.png' rel='shortcut icon' type='image/x-icon'>
				...
				<div class="col-md-12 column">
					<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
						<div class="navbar-header">
							 ...
							 <img style="height: 50px;width: 100px" src="<%=basePath %>/images/reception/logo_index.png" alt="立方" />
						</div>
								...
								<li class="dropdown">
									 ...
									 <c:if test="${sessionScope.loginStudent == null }">
										<div class="btn-group" style="margin-top: 5px;">
										    <button type="button" class="btn btn-primary" onclick="javascrtpt:window.location.href='${path }/admin/login.jsp'">教师登录</button>
											<button type="button" class="btn btn-primary" id="studentLogin">学生登录</button>
											<button type="button" class="btn btn-info" id="studentRegister">学生注册</button>
										</div>
									 </c:if>
								</li>
							</ul>
